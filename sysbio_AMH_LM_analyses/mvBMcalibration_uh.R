...
foreach(m=201:210, .packages = c("ape", "coda", "rwty", "phangorn", "lattice", "latticeExtra")) %dopar% {
...
for (k in 1:4) { #degree correlation
  
  for (j in 5:6) { #num traits
