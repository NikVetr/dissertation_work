...
write.tree(phy = trees, file = paste0("output_sim/fixCorrs_infRates_allTraits_trees_regRates_replicate_TRUEVALS_", rep_i, "_c", mcmc_rep_i, ".trees"))
write.table(rates, file = paste0("output_sim/fixCorrs_infRates_allTraits_rates_regRates_replicate_TRUEVALS_", rep_i, "_c", mcmc_rep_i, ".txt"))
write.table(lls, file = paste0("output_sim/fixCorrs_infRates_allTraits_lls_regRates_replicate_TRUEVALS_", rep_i, "_c", mcmc_rep_i, ".txt"))
write.table(rate_regs, file = paste0("output_sim/fixCorrs_infRates_allTraits_rateRegs_regRates_replicate_TRUEVALS_", rep_i, "_c", mcmc_rep_i, ".txt"))
