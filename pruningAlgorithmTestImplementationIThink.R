...
plot(density(sigmaSamples[2,3,][-(1:1000)][1:10000])); abline(v = sig[2,3], col = 2, lwd = 2)
plot(density(sigmaSamples[1,3,][-(1:1000)][1:10000])); abline(v = sig[1,3], col = 2, lwd = 2)
plot(density(sigmaSamples[1,2,][-(1:1000)][1:10000])); abline(v = sig[1,2], col = 2, lwd = 2)
plot(density(sigmaSamples[2,4,][-(1:1000)][1:10000])); abline(v = sig[2,4], col = 2, lwd = 2)
plot(density(sigmaSamples[1,4,][-(1:1000)][1:10000])); abline(v = sig[1,4], col = 2, lwd = 2)
plot(density(sigmaSamples[3,5,][-(1:1000)][1:10000])); abline(v = sig[3,5], col = 2, lwd = 2)
plot(density(sigmaSamples[2,5,][-(1:1000)][1:10000])); abline(v = sig[2,5], col = 2, lwd = 2)
plot(density(sigmaSamples[1,5,][-(1:1000)][1:10000])); abline(v = sig[1,5], col = 2, lwd = 2)
plot(density(sigmaSamples[3,4,][-(1:1000)][1:10000])); abline(v = sig[3,4], col = 2, lwd = 2)
plot(density(sigmaSamples[4,5,][-(1:1000)][1:10000])); abline(v = sig[4,5], col = 2, lwd = 2)

meanLiabs
plot(density(betaSamples[-1,,][1,1,][-(1:1000)][1:10000])); abline(v = meanLiabs[1,1], col = 2, lwd = 2)
plot(density(betaSamples[-1,,][1,2,][-(1:1000)][1:10000])); abline(v = meanLiabs[1,2], col = 2, lwd = 2)
plot(density(betaSamples[-1,,][1,3,][-(1:1000)][1:10000])); abline(v = meanLiabs[1,3], col = 2, lwd = 2)
plot(density(betaSamples[-1,,][2,1,][-(1:1000)][1:10000])); abline(v = meanLiabs[2,1], col = 2, lwd = 2)
plot(density(betaSamples[-1,,][2,2,][-(1:1000)][1:10000])); abline(v = meanLiabs[2,2], col = 2, lwd = 2)
plot(density(betaSamples[-1,,][2,3,][-(1:1000)][1:10000])); abline(v = meanLiabs[2,3], col = 2, lwd = 2)
plot(density(betaSamples[-1,,][3,1,][-(1:1000)][1:10000])); abline(v = meanLiabs[3,1], col = 2, lwd = 2)
plot(density(betaSamples[-1,,][3,2,][-(1:1000)][1:10000])); abline(v = meanLiabs[3,2], col = 2, lwd = 2)
plot(density(betaSamples[-1,,][3,3,][-(1:1000)][1:10000])); abline(v = meanLiabs[3,3], col = 2, lwd = 2)
plot(density(betaSamples[-1,,][4,1,][-(1:1000)][1:10000])); abline(v = meanLiabs[4,1], col = 2, lwd = 2)
plot(density(betaSamples[-1,,][4,2,][-(1:1000)][1:10000])); abline(v = meanLiabs[4,2], col = 2, lwd = 2)
plot(density(betaSamples[-1,,][4,3,][-(1:1000)][1:10000])); abline(v = meanLiabs[4,3], col = 2, lwd = 2)
plot(density(betaSamples[-1,,][5,1,][-(1:1000)][1:10000])); abline(v = meanLiabs[5,1], col = 2, lwd = 2)
plot(density(betaSamples[-1,,][5,2,][-(1:1000)][1:10000])); abline(v = meanLiabs[5,2], col = 2, lwd = 2)
plot(density(betaSamples[-1,,][5,3,][-(1:1000)][1:10000])); abline(v = meanLiabs[5,3], col = 2, lwd = 2)
